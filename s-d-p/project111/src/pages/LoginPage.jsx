  ...
  return (
    <Box sx={{ marginRight: 155 }}>
      ...
      >
        ...
        >
          <Typography sx={{ textAlign: 'center', mb: 2, color: 'black' }} variant='h4'>LOGIN</Typography>
          <TextField
            id="email"
            label="Email"
            variant="outlined"
          ...
          <TextField
            ...
            margin="normal"
          />
          <Button sx={{ width: '100%', mt: 2, backgroundColor: 'black' }} variant="contained" type="submit">
            SUBMIT
          </Button>
          {error.login && (
            <Typography color="error" variant="body2" sx={{ mt: 2 }}>
